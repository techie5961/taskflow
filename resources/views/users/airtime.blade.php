...
@section('main')
    <section class="w-full column p-10 g-10">
         <div class="w-full column g-10 mmax-w-500 br-10 p-10">
             <div class="row p-10 space-between br-10 align-center">
                ...
                <span class="desc bold">Topup Airtime</span>
        ...
        <div style="background:rgba(0,0,0,0.5) !important;backdrop-filter:blur(30px);-webkit-backdrop-filter:blur(30px);" class="pos-absolute max-w-500 average display-none networks top-full w-full column p-10 g-2 br-10">
            <div class="angle"></div>
            <div onclick="
             try{
        ...
        <div class="w-full grid grid-full g-10 grid-3 pc-grid-6">
            ...
            amount.classList.remove('active');
              ...
              document.querySelector('button.topup').classList.remove('disabled');
                ...
                " class="column bg-light transition-ease-half amount no-select justify-center p-10 w-full g-5 pc-pointer">
    ...
    SlideUp(data);
        " class="post topup br-0 clip-0 bold disabled">Topup Airtime</button>
    </div>
    </section>
@endsection
