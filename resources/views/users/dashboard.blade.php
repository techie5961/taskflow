...
{{-- MARGINALIZE --}}
   ...
   {{-- QUICK LINKS --}}
       ...
       <section style="padding-top:5px;" class="grid quick-links p-20 grid-2 pc-grid-4 w-full place-center g-10">
      {{-- NEW QUICK LINK --}}
        <div onclick="spa(event,'{{ url('users/team') }}')" class="column g-10 br-10 justify-center w-full perfect-square quick-link">
...
<path d="M18.5526 18.986C20.4826 18.8538 21.9999 17.8044 21.9999 16.5294C21.9999 15.2662 20.5088 14.2245 18.6041 14.0767C19.1433 14.744 19.4999 15.5558 19.4999 16.5C19.4999 17.474 19.1205 18.3071 18.5526 18.986Z" fill="CurrentColor"></path>
         ...
         {{-- NEW QUICK LINK --}}
          <div onclick="window.open('{{ $social->advert_link }}')" class="column bg-light g-10 br-10 justify-center w-full perfect-square quick-link">
           <div class="column align-center content g-10">
         ...
         {{-- NEW QUICK LINK --}}
          <div onclick="window.open('{{ $social->whatsapp }}')" class="column bg-light g-10 br-10 justify-center w-full perfect-square quick-link">
           <div class="column align-center content g-10">
        ...
        {{-- NEW QUICK LINK --}}
          <div onclick="window.open('{{ $social->telegram }}')" class="column bg-light g-10 br-10 justify-center w-full perfect-square quick-link">
           <div class="column align-center content g-10">
