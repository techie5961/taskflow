...
@endsection
@section('main')
     <section class="column p-20 bg-light w-full flex-auto justify-center">
       {{-- LOGIN FORM --}}
        <form action="{{ url('users/post/login/process') }}" method="POST" onsubmit="PostRequest(event,this,MyFunc.call_back)" class="w-full bg-light max-w-500 align-center br-10 bg-transparent c-white column g-10">
            ...
            <span class="desc bold">Welcome Back</span>
            <span class="opacity-07">Login to access your dashboard</span>
           ...
           {{-- NEW INPUT --}}
            ...
            <div style="border:0.1px solid var(--bg-lighter);" class="cont bg row align-center w-full h-50 br border-1 border-color-silver">
