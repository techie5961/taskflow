...
@section('main')
    <section class="column g-10 w-full flex-auto p-10 justify-center">
        ...
        " class="btn-green-3d display-none clip-5 br-5">Spin & Win</button>
    </section>
@endsection
@section('js')
    <script class="js">
        window.MyFunc = {
            Spinned : function(response){
                let data=JSON.parse(response);
                CreateNotify(data.status,data.message);
               
                    document.querySelector('svg.spin').style.animation='spin 2.5s ease-out forwards';
